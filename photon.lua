...
-- connections
local pf_conn_data = ProtoField.bytes("photon.command.conn_data", "Data", base.SPACE) -- base.HEX

-- connection verifications
local pf_connverify_data = ProtoField.bytes("photon.command.connverify_data", "Data", base.SPACE) -- base.HEX
...
local pf_command_msg_parameters = ProtoField.bytes("photon.command.message.parameters", "Parameters", base.SPACE) -- base.HEX
